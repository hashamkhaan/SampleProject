...
import AddBlocks from '../Booking/AddBlocks';
...
const TablePage = () => {
	...
	useEffect(() => {
		...
		Axios.get(`${baseURL}/getBlocks?pageNo=1&&records=10&&sort=asc&&colName=id`)
			.then((response) => {
				console.log('GET getBlocks::::::::', response.data);
				setPlots(response.data.blocks.data);
