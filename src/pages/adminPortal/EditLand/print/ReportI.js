...
const GeneratePDF = (data1, type) => {
	...
	const dataMain = [
		...
		`${totalPurchasingLand.kanal}-${totalPurchasingLand.marla}-${totalPurchasingLand.sarsai}-${totalPurchasingLand.feet}`,
	...
	const landTotal = [
		...
		// },
		{
			content: ` ${totalPurchasingLand.kanal}-${totalPurchasingLand.marla}-${totalPurchasingLand.sarsai}-${totalPurchasingLand.feet}  `,
			colSpan: 1,
			rowSpan: 1,
			styles: { halign: 'left', fontStyle: 'bold', fontSize: 10 },
		},
	...
	const TableDataSummary4 = [
		{
			// content: `Total Land in marlas:   ${data1.form1.file_no}`,
			content: `Total Purchasing Land: ${totalPurchasingLand.kanal}-${totalPurchasingLand.marla}-${totalPurchasingLand.sarsai}-${totalPurchasingLand.feet} `,
			colSpan: 1,
			rowSpan: 1,
			styles: { halign: 'right', fontStyle: 'bold', fontSize: 10 },
		},
