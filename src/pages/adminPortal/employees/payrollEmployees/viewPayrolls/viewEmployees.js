					...
					<ModalTitle id='deltefile'>
						...
						<CardHeader>
							<CardLabel icon='Delete' iconColor='info'>
								Deletion Confirmation Employee Name: {editingEmployeeData?.code}
								<small> Employee ID: {editingEmployeeData?.name}</small>
							</CardLabel>
						</CardHeader>
					</ModalTitle>
				</ModalHeader>
						...
						<div className='col-12'>
							<Card>
								<CardBody>
									...
									Name: {editingEmployeeData?.name} <br />
						...
						<CardHeader>
							<CardLabel icon='Edit' iconColor='info'>
								<CardTitle>
									...
									<small> Employee Code: {editingEmployeeData?.code}</small>
								</CardTitle>
							</CardLabel>
						</CardHeader>
					</ModalTitle>
