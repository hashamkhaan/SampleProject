...
const ADMINROLES = {
	ADDADMIN: lazy(() => import('../pages/AdminRoles/add')),
	LISTADMIN: lazy(() => import('../pages/AdminRoles/list')),
};
const EMPLOYEES = {
	MANAGEEMPLOYEES: lazy(() => import('../pages/adminPortal/employees/manageEmployees/index')),
	PAYROLLEMPLOYEES: lazy(() => import('../pages/adminPortal/employees/payrollEmployees/index')),
	VIEWPAYROLLEMPLOYEES: lazy(() =>
		import('../pages/adminPortal/employees/payrollEmployees/viewPayrolls/index'),
	),
};
const LISTINGS = {
	MANAGEPERSONS: lazy(() => import('../pages/adminPortal/persons/managePersons/index')),
	MANAGEMOUZA: lazy(() => import('../pages/adminPortal/persons/manageMouza/index')),
	MANAGEKHASRA: lazy(() => import('../pages/adminPortal/persons/manageKhasra/index')),
};
const LOANAMORTIZATION = {
	MANAGELOANAMORTIZATION: lazy(() =>
		import('../pages/adminPortal/loanAmortization/manageLoanAmortization/index'),
	),
};

const BOOKINGSECTION = {
	LIST_POTS: lazy(() => import('../pages/manage/allPlots')),
};
const ADMINPORTALLANDING = {
	DASHBOARD: lazy(() => import('../pages/adminPortal/dashboard/index')),
	PURCHASELAND: lazy(() => import('../pages/adminPortal/purchaseLand/index')),
	EDITLAND: lazy(() => import('../pages/adminPortal/EditLand/index')),
	VIEWPURCHASELAND: lazy(() => import('../pages/adminPortal/ViewPurchasedLand/index')),
	VIEWKHASRARECORDS: lazy(() => import('../pages/adminPortal/viewKhasrasRecord/index')),
	VIEWKMOUZARECORDS: lazy(() => import('../pages/adminPortal/viewMouzasRecord/index')),
	// Accounts
	NEWTRANSACTION: lazy(() => import('../pages/adminPortal/accounts/allVouchersList/index')),
	VIEWTRANSACTIONS: lazy(() => import('../pages/adminPortal/accounts/viewAccounts/index')),
	DEPRECIATION: lazy(() => import('../pages/adminPortal/depreciation/index')),

	ACCOUNTHEADSSUBGROUPS: lazy(() =>
		import('../pages/adminPortal/accounts/accountsHeadsSubgroups/index'),
	),
	VOUCHERS: lazy(() => import('../pages/adminPortal/accounts/vouchers/index')),

	FILESVOUCHERS: lazy(() => import('../pages/adminPortal/accounts/filesVouchers/index')),
};
const LANDING = {
...
const presentation = [
	 ...
	 */
	{
		path: adminPortal.admindashboard.path,
		element: <ADMINPORTALLANDING.DASHBOARD />,
		exact: true,
	},
	{
		path: adminPortal.pL.subMenu.purchaseLand.path,
		element: <ADMINPORTALLANDING.PURCHASELAND />,
		exact: true,
	},
	{
		path: `${subDir}adminPortal/lands/editPurchaseLand`,
		element: <ADMINPORTALLANDING.EDITLAND />,
		exact: true,
	},
	{
		path: adminPortal.pL.subMenu.viewPurchaseLand.path,
		element: <ADMINPORTALLANDING.VIEWPURCHASELAND />,
		exact: true,
	},
	{
		path: adminPortal.viewKhasrasRecord.path,
		element: <ADMINPORTALLANDING.VIEWKHASRARECORDS />,
		exact: true,
	},
	{
		path: adminPortal.viewMouzasRecord.path,
		element: <ADMINPORTALLANDING.VIEWKMOUZARECORDS />,
		exact: true,
	},
	{
		path: accountsModule.accounts.subMenu.newTransaction.path,
	...
	{
		path: accountsModule.vouchers.path,
		element: <ADMINPORTALLANDING.VOUCHERS />,
		exact: true,
	},

	{
		path: accountsModule.fileVouchers.path,
		element: <ADMINPORTALLANDING.FILESVOUCHERS />,
		exact: true,
	},

	// Employees Module Paths, By Hashim
	{
		path: employeesModule.employees.subMenu.manageEmployees.path,
		element: <EMPLOYEES.MANAGEEMPLOYEES />,
		exact: true,
	},
	{
		path: employeesModule.employees.subMenu.payrollEmployees.path,
		element: <EMPLOYEES.PAYROLLEMPLOYEES />,
		exact: true,
	},
	{
		path: employeesModule.employees.subMenu.viewPayrollsEmployees.path,
		element: <EMPLOYEES.VIEWPAYROLLEMPLOYEES />,
		exact: true,
	},
	{
		path: listings.listings.subMenu.managePersons.path,
		element: <LISTINGS.MANAGEPERSONS />,
		exact: true,
	},
	{
		path: listings.listings.subMenu.manageMouza.path,
		element: <LISTINGS.MANAGEMOUZA />,
		exact: true,
	},
	{
		path: listings.listings.subMenu.manageKhasra.path,
		element: <LISTINGS.MANAGEKHASRA />,
		exact: true,
	},
	{
		path: loanModule.loan.subMenu.manageLoans.path,
		element: <LOANAMORTIZATION.MANAGELOANAMORTIZATION />,
		exact: true,
	},
	// admin roles, By Haris
	{
	...
	{
		path: rolesAdmin.adminRoles.subMenu.listAdmin.path,
		element: <ADMINROLES.LISTADMIN />,
		exact: true,
	},

	{
		path: bookingForm.plotsLiting.subMenu.Plotisting.path,
		element: <BOOKINGSECTION.LIST_POTS />,
		exact: true,
	},
	...
	{
		path: `${demoPages.crm.subMenu.invoice.path}`,
		element: <APP.CRM.INVOICE />,
		exact: true,
	},
