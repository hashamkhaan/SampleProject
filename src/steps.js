		...
		<div className='row'>
			...
			<div className='col-md-8 d-flex align-items-center'>
				<div>
					...
					<p>
						With the UI, form and layout components specially prepared for REHBAR, you
			...
			<div className='col-md-8 flex-wrap d-flex align-items-center'>
				<div className='row'>
					<div className='col'>
						...
						<p>The designs of the added packages are compatible with "REHBAR".</p>
						<p>
		...
		<div className='row'>
			...
			<div className='col-md-8 d-flex align-items-center'>
				<div>
					...
					<p>
						Some sample screens have been made with "REHBAR" and it can give you an idea
						for your project.
					</p>
					<p>
		...
		<div className='row'>
			...
			<div className='col-md-8 d-flex align-items-center'>
				<div>
					...
					<p>Here you can find detailed usage of ui and form components for REHBAR.</p>
				</div>
			</div>
			<TourNavigation />
		</div>
